                            ...
                            <div className="col-10 col-md-8 col-lg-6 col-xl-5">
                                <div className="card" style={{ borderRadius: "15px" }}>
                                    ...
                                    <div className="card-body p-3">
                                        <h2 className=" text-center mb-5">Login or Signup</h2>
                                        ...
                                        <form>
                                            ...
                                            <div className="d-flex justify-content-center">
                                                <button type="button"
                                                    className="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><span className="btntext">Register</span></button>
                                            </div>

                                            <p className="text-center text-muted mt-5 mb-0">Have an account already? <a href="#!"
